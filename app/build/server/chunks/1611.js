"use strict";exports.id=1611,exports.ids=[1611],exports.modules={91611:(e,r,t)=>{t.r(r),t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});let template=async(e,r)=>`
...
[include RatOS/printers/v-core-3-idex/${e.size.x}.cfg]
...
${r.renderUserStepperSections({x:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.x,endstop:0-r.min}),additionalLines:[]},dual_carriage:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0,max:e.size.x+r.max,endstop:e.size.x+r.max}),safeDistance:60},y:{directionInverted:!0,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.y+r.max,endstop:e.size.y+r.max})},y1:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys"},z:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws",limits:{min:0,max:e.size.z}},z1:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws"},z2:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws"},extruder:{directionInverted:!0,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 28.413","pid_ki: 1.334","pid_kd: 151.300"]},extruder1:{directionInverted:!0,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 28.413","pid_ki: 1.334","pid_kd: 151.300"]}})}
