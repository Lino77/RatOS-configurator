"use strict";exports.id=9774,exports.ids=[9774],exports.modules={49774:(e,r,t)=>{t.r(r),t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});let template=async(e,r)=>`
...
[include RatOS/printers/voron-v24/${e.size.x}.cfg]
...
${r.renderUserStepperSections({x:{directionInverted:!0,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.x+r.max,endstop:e.size.x+r.max})},y:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.y+r.max,endstop:e.size.y+r.max})},z:{directionInverted:!0,limits:{min:0,max:e.size.z}},z1:{directionInverted:!0},z2:{directionInverted:!0},z3:{directionInverted:!0},extruder:{directionInverted:!0,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 21.673","pid_ki: 1.338","pid_kd: 87.776"]}})}
