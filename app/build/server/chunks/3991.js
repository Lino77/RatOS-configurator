"use strict";exports.id=3991,exports.ids=[3991],exports.modules={23991:(e,r,t)=>{t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});var o=t(73922);let template=async(e,r)=>{let t={xcontrolpoint:e.size.x/2-37.5,ycontrolpoint:e.size.y+30.5,zcontrolpoint:10,zoffsetcontrolpoint:0};return`
...
${(0,o.N)(e,{proximityMargins:{left:20,right:20,top:20,bottom:20},contactMargins:{left:20,right:20,top:20,bottom:20},enableAdaptiveHeatsoak:!0})}
