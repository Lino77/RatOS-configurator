"use strict";exports.id=5913,exports.ids=[5913],exports.modules={15913:(e,r,t)=>{t.r(r),t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});var i=t(10417);let template=async(e,r)=>`
...
#############################################################################################################
${r.renderBase()}
[include RatOS/printers/v-core-4-1/v-core-4-1.cfg]
[include RatOS/printers/v-core-4-1/macros.cfg]
[include RatOS/printers/v-core-4-1/${e.size.x}.cfg]
...
${(0,i.maybeRenderBeaconOverrides)(e,{proximityMargins:{left:20,right:20,top:20,bottom:20},contactMargins:{left:20,right:20,top:20,bottom:20},offset:{x:0,y:19.5},enableAdaptiveHeatsoak:!0})}
