"use strict";exports.id=4635,exports.ids=[4635],exports.modules={54635:(e,r,t)=>{t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});let template=(e,r)=>`
...
#############################################################################################################
${r.renderBase()}
[include RatOS/printers/tridex/tridex.cfg]
[include RatOS/printers/tridex/macros.cfg]
[include RatOS/printers/tridex/${e.size.x}.cfg]
...
${r.renderUserStepperSections({x:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.x,endstop:0-r.min}),additionalLines:[]},dual_carriage:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0,max:e.size.x+r.max,endstop:e.size.x+r.max}),safeDistance:75},y:{directionInverted:!0,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.y+r.max,endstop:0-r.min})},y1:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys"},z:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws",limits:{min:0,max:e.size.z}},z1:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws"},z2:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws"},extruder:{directionInverted:!1,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 37.050","pid_ki: 4.491","pid_kd: 76.415"]},extruder1:{directionInverted:!1,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 37.050","pid_ki: 4.491","pid_kd: 76.415"]}})}
