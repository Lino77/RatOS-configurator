"use strict";exports.id=2720,exports.ids=[2720],exports.modules={62720:(e,r,t)=>{t.r(r),t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});var o=t(10417);let template=async(e,r)=>{let t={xcontrolpoint:e.size.x/2-37.5,ycontrolpoint:e.size.y+30.5,zcontrolpoint:10,zoffsetcontrolpoint:0};return`
...
[include RatOS/printers/v-core-4-idex/${e.size.x}.cfg]
...
${(0,o.maybeRenderBeaconOverrides)(e,{proximityMargins:{left:20,right:20,top:20,bottom:20},contactMargins:{left:20,right:20,top:20,bottom:20},enableAdaptiveHeatsoak:!0})}
