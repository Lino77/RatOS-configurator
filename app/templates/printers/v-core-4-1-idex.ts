...
[include RatOS/printers/v-core-4-1-idex/${config.size.x}.cfg]
...
### FANS
#############################################################################################################
${helper.renderFans({ hotendFanSpeed: 0.5 })}
